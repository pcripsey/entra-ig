    ...
    async def _run(self, run_id: str, sync_type: str, progress: LiveProgress) -> None:
        try:
            ...
            await self._run_store.update_run(
                ...
                nested_groups_count=result.nested_groups_count,
                identity_file=result.identity_file,
                account_file=result.account_file,
                group_file=result.group_file,
                group_membership_file=result.group_membership_file,
                parent_child_group_file=result.parent_child_group_file,
                permission_file=result.permission_file,
                holder_to_permission_file=result.holder_to_permission_file,
                permission_to_holder_file=result.permission_to_holder_file,
                permission_hierarchy_cp_file=result.permission_hierarchy_cp_file,
                permission_hierarchy_pc_file=result.permission_hierarchy_pc_file,
